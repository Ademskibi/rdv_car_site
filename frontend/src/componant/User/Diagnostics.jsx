...
import { Gauge, Calendar, Upload, User, FileText, Car, Zap } from "lucide-react";
...
const Diagnostics = () => {
  const [formData, setFormData] = useState({
    First_Name: "",
    Last_Name: "",
    phone: "", // lowercase to match backend
    Matricule: "",
    Model: "",
    Motor_type: "",
    Type: false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else setError("❌ Failed to schedule diagnostic appointment. Please try again.");
    } finally {
        ...
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-800 p-8 shadow-2xl">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                    <User className="w-4 h-4 mr-2 text-red-500" /> First Name
                  </label>
                  <input
                    type="text"
                    name="First_Name"
                    ...
                    className="w-full bg-gray-800 border border-gray-700 rounded-xl p-4 text-white placeholder-gray-400 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20"
                    required
                  />
                </div>
                ...
                <div>
                  <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                    <User className="w-4 h-4 mr-2 text-red-500" /> Last Name
                  </label>
                  <input
                    type="text"
                    name="Last_Name"
              ...
              <div>
                <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                  <FileText className="w-4 h-4 mr-2 text-red-500" /> Vehicle Plate
                </label>
                <select
                  value={selectedType}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                    <Car className="w-4 h-4 mr-2 text-red-500" /> Car Model
                  </label>
                  <input
                    type="text"
                    name="Model"
                ...
                <div>
                  <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                    <Zap className="w-4 h-4 mr-2 text-red-500" /> Motor Type
                  </label>
                  <select
                    name="Motor_type"
              ...
              <div>
                <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                  <Calendar className="w-4 h-4 mr-2 text-red-500" /> Diagnostic Date
                </label>
                <DatePicker
              ...
              <div>
                <label className="flex items-center text-gray-300 mb-2 text-sm font-semibold">
                  <Upload className="w-4 h-4 mr-2 text-red-500" /> Upload Vehicle Photos (Optional)
                </label>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isSubmitting ? "SCHEDULING..." : "SCHEDULE VEHICLE DIAGNOSTICS"}
              </button>
            </form>
          </div>
        </div>
